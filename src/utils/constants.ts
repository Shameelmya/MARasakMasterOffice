...
export const DEFAULT_USERS: User[] = [
  { id: 'admin', name: 'M. A. Razak Master (MLA)', role: 'admin', pass: 'Master@2026', enabled: true, canInput: true, canSeeReports: true, canSeeGlobalOverview: true, canEditGlobalOverview: true, canEditOwnInputs: true, canReassign: true, canGenerateUpdationReport: true, canSeeRecentUpdations: true, phone: '', whatsapp: '' }
];
