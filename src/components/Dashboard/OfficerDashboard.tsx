      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[#2d1b4e] shadow-[0_-10px_30px_rgba(0,0,0,0.2)] border-t border-purple-800/50 pt-2 px-2 sm:px-4 z-[90] pb-2 sm:pb-4 transition-transform duration-300 transform-gpu translate-y-0">
        <div className="flex justify-between items-end w-full max-w-md mx-auto h-full">
          <button 
            ...
            className={`flex flex-col items-center gap-1 transition-all flex-1 py-1 ${activeTab === 'recent' && !mobileSettingsOpen ? 'text-[#2d1b4e]' : 'text-purple-300/70 hover:text-purple-200'}`}
          >
            <div className={`p-2 sm:p-2.5 rounded-[18px] transition-colors ${activeTab === 'recent' && !mobileSettingsOpen ? 'bg-white shadow-sm' : 'bg-transparent'}`}><Bell size={22} strokeWidth={2.5} /></div>
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 transition-all flex-1 py-1 ${activeTab === 'worker' && !mobileSettingsOpen ? 'text-[#2d1b4e]' : 'text-purple-300/70 hover:text-purple-200'}`}
          >
            <div className={`p-2 sm:p-2.5 rounded-[18px] transition-colors ${activeTab === 'worker' && !mobileSettingsOpen ? 'bg-white shadow-sm' : 'bg-transparent'}`}><Activity size={22} strokeWidth={2.5} /></div>
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 transition-all flex-1 py-1 ${activeTab === 'history' && !mobileSettingsOpen ? 'text-[#2d1b4e]' : 'text-purple-300/70 hover:text-purple-200'}`}
          >
            <div className={`p-2 sm:p-2.5 rounded-[18px] transition-colors ${activeTab === 'history' && !mobileSettingsOpen ? 'bg-white shadow-sm' : 'bg-transparent'}`}><FileText size={22} strokeWidth={2.5} /></div>
